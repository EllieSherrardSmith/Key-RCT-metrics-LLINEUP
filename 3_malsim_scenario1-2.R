...
## Data
test_data = read.csv("simulation-summary/scenario_1-2.csv",header=TRUE)
...
write.csv(test_data,"C:/Users/esherrar/Documents/Rprojects/Key-RCT-metrics-LLINEUP/simulation-summary/scenario_1-2.csv")
...
mod_sims_scenario_1_2 = expand.grid(
  timestep = scenario_0$timestep
)
for(i in 1:nrow(test_data)){
  mod_sims_scenario_1_2[,i+1] = uganda_1_f(i)[,2]
  print(i)
}

for(i in 1:nrow(test_data)){
  colnames(mod_sims_scenario_1_2)[i+1] = paste0("cluster",test_data$cluster[i],"_prev")  
}


write.csv(mod_sims_scenario_1_2, "simulation-summary/mod_sims_scenario_1_2.csv")
...
## colours align 
par(mfrow=c(2,2))
plot(scenario_1_2[,2] ~ scenario_1_2$timestep,type="l",
     ylab = "Prevalence in children 6m to 10yrs (%)",yaxt="n",ylim=c(0,0.8),
...
for(i in c(which(test_data$Net_Type == "Olyset Net")+1)){
  lines(scenario_1_2[,i] ~ scenario_1_2$timestep,col="darkred")
}
...
for(i in c(which(test_data$Net_Type == "Olyset Plus")+1)){
  lines(scenario_1_2[,i] ~ scenario_1_2$timestep,col="orange")
}
...
for(i in c(which(test_data$Net_Type == "PermaNet 2.0")+1)){
  lines(scenario_1_2[,i] ~ scenario_1_2$timestep,col="blue")
}
...
for(i in c(which(test_data$Net_Type == "PermaNet 3.0")+1)){
  lines(scenario_1_2[,i] ~ scenario_1_2$timestep,col="darkgreen")
}
...
for(i in 1:length(c(which(test_data$Net_Type == "Olyset Net")))){
  prev_mod_ol[1,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365/2),olys[i]]
  prev_mod_ol[2,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365),olys[i]]
  prev_mod_ol[3,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365+365/2),olys[i]]
  prev_mod_ol[4,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365*2+30),olys[i]] 
}
...
for(i in 1:length(c(which(test_data$Net_Type == "Olyset Plus")))){
  prev_mod_olP[1,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365/2),olyP[i]]
  prev_mod_olP[2,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365),olyP[i]]
  prev_mod_olP[3,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365+365/2),olyP[i]]
  prev_mod_olP[4,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365*2+30),olyP[i]] 
}
...
for(i in 1:length(c(which(test_data$Net_Type == "PermaNet 2.0")))){
  prev_mod_Pe2[1,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365/2),Per2[i]]
  prev_mod_Pe2[2,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365),Per2[i]]
  prev_mod_Pe2[3,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365+365/2),Per2[i]]
  prev_mod_Pe2[4,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365*2+30),Per2[i]] 
}
...
for(i in 1:length(c(which(test_data$Net_Type == "PermaNet 3.0")))){
  prev_mod_Pe3[1,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365/2),Per3[i]]
  prev_mod_Pe3[2,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365),Per3[i]]
  prev_mod_Pe3[3,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365+365/2),Per3[i]]
  prev_mod_Pe3[4,i] = scenario_1_2[c(6*365+dat$days_after_jan_2017[i]+365*2+30),Per3[i]] 
}
