...
## Data
test_data = read.csv("simulation-summary/scenario_1.csv",header=TRUE)
...
write.csv(test_data,"C:/Users/esherrar/Documents/Rprojects/Key-RCT-metrics-LLINEUP/simulation-summary/scenario_1.csv")
...
##
## Simulate 
test_data = read.csv("C:/Users/esherrar/Documents/Rprojects/Key-RCT-metrics-LLINEUP/simulation-summary/scenario_1.csv",header=TRUE)
...
mod_sims_scenario_1 = expand.grid(
  timestep = scenario_0$timestep
)
for(i in 1:nrow(test_data)){
  mod_sims_scenario_1[,i+1] = uganda_1_f(i)[,2]
}

for(i in 1:nrow(test_data)){
  colnames(mod_sims_scenario_1)[i+1] = paste0("arm",test_data$arm[i],"_prev")  
}


write.csv(mod_sims_scenario_1, "simulation-summary/mod_sims_scenario_1.csv")
...
scenario_1 = read.csv("simulation-summary/mod_sims_scenario_1.csv",header=TRUE)
## input parameters for scenario
test_data = read.csv("C:/Users/esherrar/Documents/Rprojects/Key-RCT-metrics-LLINEUP/simulation-summary/scenario_1.csv",header=TRUE)
## looking across clusters
dat = read.csv("simulation-summary/scenario_2.csv",header=TRUE)

plot(scenario_1$arm1_prev ~ scenario_1$timestep,type="l",
...
lines(scenario_1$arm2_prev ~ scenario_1$timestep,col="orange")
lines(scenario_1$arm3_prev ~ scenario_1$timestep,col="blue")
lines(scenario_1$arm4_prev ~ scenario_1$timestep,col="darkgreen")
...
prev_mod = c(scenario_1$arm1_prev[c(c(6*365+dat$days_after_jan_2017[dat$Net_Type == "Olyset Net"]+365/2),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "Olyset Net"]+365),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "Olyset Net"]+365+365/2),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "Olyset Net"]+365*2+30))],
             scenario_1$arm2_prev[c(c(6*365+dat$days_after_jan_2017[dat$Net_Type == "Olyset Plus"]+365/2),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "Olyset Plus"]+365),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "Olyset Plus"]+365+365/2),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "Olyset Plus"]+365*2+30))],
             scenario_1$arm3_prev[c(c(6*365+dat$days_after_jan_2017[dat$Net_Type == "PermaNet 2.0"]+365/2),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "PermaNet 2.0"]+365),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "PermaNet 2.0"]+365+365/2),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "PermaNet 2.0"]+365*2+30))],
             scenario_1$arm4_prev[c(c(6*365+dat$days_after_jan_2017[dat$Net_Type == "PermaNet 3.0"]+365/2),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "PermaNet 3.0"]+365),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "PermaNet 3.0"]+365+365/2),
                                    c(6*365+dat$days_after_jan_2017[dat$Net_Type == "PermaNet 3.0"]+365*2+30))])
